...
type Repository interface {
	...
	ListProductsWithID(ctx context.Context, ids []string) ([]Product, error)
...
func (r *elasticRepository) ListProductsWithID(ctx context.Context, ids []string) ([]Product, error) {
